...
@section('main-content')
    ...
    <nav class="page-breadcrumb d-flex align-items-center justify-content-between">
        ...
        <div class="float-end">
            @can('create bill')
                <a href="{{ route('admin.bill.create', $vendor->id) }}" class="btn btn-primary">
                    {{ __('Create Bill') }}
                </a>
            @endcan
{{-- 
            @can('edit vender')
                <a href="#" class="btn btn-info" data-size="xl"
                    data-url="{{ route('admin.vender.edit', $vendor['id']) }}" data-ajax-popup="true"
                    title="{{ __('Edit') }}" data-bs-toggle="tooltip" data-original-title="{{ __('Edit') }}">
                    Edit
                </a>
            @endcan
            @can('delete vender')
                {!! Form::open([
                    'method' => 'DELETE',
                    'route' => ['admin.vender.destroy', $vendor['id']],
                    'class' => 'delete-form-btn',
                    'id' => 'delete-form-' . $vendor['id'],
                ]) !!}
                <a href="#" class="btn btn-danger bs-pass-para" data-bs-toggle="tooltip"
                                                ...
                                                <span>
                                                    ...
                                                    @can('delete bill')
                                                        <div class="action-btn bg-danger ms-2">
                                                            {!! Form::open([
                                                                'method' => 'DELETE',
                                                                'route' => ['admin.bill.destroy', $bill->id],
