@canany(['manage-asset_types', 'manage-assets', 'manage-asset_management'])
    <li
        class="nav-item {{ request()->routeIs('admin.asset-types.*') ||
        ...
        <div class="{{ request()->routeIs('admin.asset-types.*') ||
        request()->routeIs('admin.assets.*') ||
        request()->routeIs('admin.asset_assignment.*')
            ? ''
            : 'collapse' }}"
            ...
            <ul class="nav sub-menu">
                ...
                @can('manage-asset_types')
                    <li class="nav-item">
                        <a href="{{ route('admin.asset-types.index') }}" data-href="{{ route('admin.asset-types.index') }}"
                ...
                @can('manage-assets')
                    <li class="nav-item">
                        <a href="{{ route('admin.assets.index') }}" data-href="{{ route('admin.assets.index') }}"
                ...
                @can('manage-asset_management')
                    <li class="nav-item">
                        <a href="{{ route('admin.asset_assignment.index') }}"
                            ...
                            class="nav-link {{ request()->routeIs('admin.asset_assignment.*') ? 'active' : '' }}">Asset
                            Management</a>
                    </li>
                @endcan
            </ul>
