    ...
    <li
        ...
        Request::segment(2) == 'debit-note'
            ...
            <ul class="nav sub-menu">
                <li class="nav-item">
                    <a class="nav-link {{ Request::segment(2) == 'bank-account' || Request::segment(2) == 'bank-transfer' ? 'active' : '' }}"
                        data-bs-toggle="collapse" href="#banking" data-href="#" role="button" aria-expanded="false">
                        <span> {{ __('Banking') }} </span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
                    </a>
                    <div class="{{ Request::segment(2) == 'bank-account' || Request::segment(2) == 'bank-transfer' ? '' : 'collapse' }}"
                        id="banking">
                        <ul class="nav sub-menu">
                            @can('manage-bank_account')
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::route()->getName() == 'admin.bank-account.index' || Request::route()->getName() == 'admin.bank-account.create' || Request::route()->getName() == 'admin.bank-account.edit' ? ' active' : '' }}"
