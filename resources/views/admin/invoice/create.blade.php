    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers, $customerId, ['class' => 'form-control select', 'id' => 'customer', 'data-url' => route('admin.invoice.customer'), 'required' => 'required']) }}
        ...
        <div class="col-12">
            <div class="card repeater">
                <div class="card-body">
                    <h5 class="d-inline-block">{{ __('Product & Services') }}</h5>
                                ...
                                <tbody class="ui-sortable" data-repeater-item>
                                    <tr>
                                        <td width="25%" class="form-group pt-0">
                                            {{ Form::select('item', $product_services, '', ['class' => 'form-control select2 item mt-3', 'data-url' => route('admin.invoice.product'), 'required' => 'required']) }}
                                        </td>
                                        <td>
        ...
        <div class="modal-footer">
            <input type="button" value="{{ __('Cancel') }}"
                onclick="location.href = '{{ route('admin.invoice.index') }}';" class="btn btn-light">
