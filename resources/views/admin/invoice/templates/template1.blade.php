            ...
            <tr>
                ...
                <td>
                    <table class="no-space" style="width: 45%;margin-left: auto;">
                        ...
                        <tr>
                            <td>{{__('Number')}}:</td>
                            <td class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                        </tr>
                        <tr>
                            <td>{{__('Issue Date')}}:</td>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="view-qrcode">
                                    {!! DNS2D::getBarcodeHTML(route('admin.invoice.link.copy',\Crypt::encrypt($invoice->invoice_id)), "QRCODE",2,2) !!}
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <tr>
                ...
                <td colspan="2" class="sub-total">
                    <table class="total-table">
                        ...
                        <tr>
                            <td>{{__('Paid')}}:</td>
                            <td>{{\App\Models\Utility::priceFormat($settings,($invoice->getTotal()-$invoice->getDue())-($invoice->invoiceTotalCreditNote()))}}</td>
                        </tr>
                        <tr>
