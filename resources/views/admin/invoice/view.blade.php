...
@section('main-content')
    ...
    <nav class="page-breadcrumb d-flex align-items-center justify-content-between">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.invoice.index') }}">{{ __('Invoice') }}</a></li>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            @if (!empty($invoicePayment))
                                <div class="all-button-box mx-2 mr-2">
                                    <a href="#" class="btn btn-primary"
                                        data-url="{{ route('admin.invoice.credit.note', $invoice->id) }}"
                            ...
                            @if ($invoice->status != 4)
                                <div class="all-button-box mr-2">
                                    <a href="{{ route('admin.invoice.payment.reminder', $invoice->id) }}"
                                        class="btn btn-primary me-2">{{ __('Receipt Reminder') }}</a>
                                </div>
                            @endif
                            <div class="all-button-box mr-2">
                                <a href="{{ route('admin.invoice.resent', $invoice->id) }}"
                                    class="btn btn-primary me-2">{{ __('Resend Invoice') }}</a>
                            </div>
                            <div class="all-button-box">
                                <a href="{{ route('admin.invoice.pdf', Crypt::encrypt($invoice->id)) }}" target="_blank"
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    @can('edit invoice')
                                        <a href="{{ route('admin.invoice.edit', \Crypt::encrypt($invoice->id)) }}"
                                            ...
                                            data-original-title="{{ __('Edit') }}">{{ __('Edit') }}</a>
                                    @endcan
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    <div class="timeline-icons">
                                    ...
                                    @if ($invoice->status == 0)
                                        @can('send bill')
                                            <a href="{{ route('admin.invoice.sent', $invoice->id) }}" class="btn btn-warning"
                                                data-bs-toggle="tooltip" data-original-title="{{ __('Mark Sent') }}">{{ __('Send') }}</a>
                                        @endcan
                                    @endif
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    @if ($invoice->status != 0)
                                        @can('create payment invoice')
                                            <a href="#" data-url="{{ route('admin.invoice.payment', $invoice->id) }}"
                                                data-ajax-popup="true" data-title="{{ __('Add Payment') }}" class="btn btn-info"
                                ...
                                <div class="col">
                                    <div class="float-end mt-3">
                                        {!! DNS2D::getBarcodeHTML(
                                            route('admin.invoice.link.copy', \Illuminate\Support\Facades\Crypt::encrypt($invoice->id)),
                                            'QRCODE',
                                            2,
                                            2,
                                        ) !!}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-border-style">
                    <h5 class="d-inline-block mb-2">{{ __('Receipt Summary') }}</h5>
                                        ...
                                        @can('delete invoice product')
                                            <td>
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open([
                                                        'method' => 'post',
                                                        'route' => ['admin.invoice.payment.destroy', $invoice->id, $payment->id],
                                        ...
                                        @can('delete invoice product')
                                            <td>
                                                ...
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open([
                                                        'method' => 'post',
                                                        'route' => ['admin.invoice.payment.destroy', $invoice->id, $bankPayment->id],
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body table-border-style">
                    <h5 class="d-inline-block mb-2">{{ __('Credit Note Summary') }}</h5>
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <td>
                                        @can('edit credit note')
                                            <div class="action-btn bg-primary ms-2">
                                                <a data-url="{{ route('admin.invoice.edit.credit.note', [$creditNote->invoice, $creditNote->id]) }}"
                                        ...
                                        @can('delete credit note')
                                            <div class="action-btn bg-danger ms-2">
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['admin.invoice.delete.credit.note', $creditNote->invoice, $creditNote->id],
