    ...
    <script>
        ...
        $(document).on('click', '[data-repeater-delete]', function() {
            ...
            if (confirm('Are you sure you want to delete this element?')) {
                ...
                $.ajax({
                    url: '{{ route('admin.bill.product.destroy') }}',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('#token').val()
                    },
...
@section('main-content')
    ...
    <nav class="page-breadcrumb d-flex align-items-center justify-content-between">
        ...
        <div class="float-end">
            <a href="{{ route('admin.bill.index') }}" class="btn btn-primary">
                Back
            </a>
        </div>
    </nav>
    <div class="row">
        {{ Form::model($bill, ['route' => ['admin.bill.update', $bill->id], 'method' => 'PUT', 'class' => 'w-100']) }}
        <div class="col-12">
                        ...
                        <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group price-input input-group search-form">
                                                {{ Form::text('quantity[]', $iteam->quantity, ['class' => 'form-control quantity', 'placeholder' => __('Qty'), 'required' => 'required']) }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group price-input input-group search-form">
                                                {{ Form::text('price[]', $iteam->price, ['class' => 'form-control price', 'placeholder' => __('Price'), 'readonly' => 'readonly']) }}
                                                <span
                                        ...
                                        @php
                                            $Total_Amount =
                                                $iteam->price * $iteam->quantity - $iteam->discount + $totalTaxPrice;
                                        @endphp
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-end">{{ \Auth::user()->currencySymbol() }}
                                        <span class="subTotal">
                                            {{ number_format($bill->getSubTotal(), 2, '.', ',') }}
                                        </span>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end">{{ \Auth::user()->currencySymbol() }}
                                        <span class="totalDiscount">
                                            {{ number_format($bill->getTotalDiscount(), 2, '.', ',') }}
                                    </td>
                                    </span>
                                    <td></td>
                                </tr>
        ...
        <div class="modal-footer">
            <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('admin.bill.index') }}';"
