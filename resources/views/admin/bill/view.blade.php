                        ...
                        <div class="card-body">
                            <div class="row timeline-wrapper">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    @if ($bill->status == 0)
                                        <a href="{{ route('admin.bill.sent', $bill->id) }}" class="btn btn-warning"
                                            data-bs-toggle="tooltip"
                                            data-original-title="{{ __('Mark Sent') }}">{{ __('Send') }}</a>
                                    @endif
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    <div class="timeline-icons"><span class="timeline-dots"></span>
                                    ...
                                    @if ($bill->status != 0)
                                        @can('create-bill')
                                            <a href="#" data-url="{{ route('admin.bill.payment', $bill->id) }}"
                ...
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    @if (!empty($billPayment))
                        <div class="all-button-box mx-2">
                            <a href="#" data-url="{{ route('admin.bill.debit.note', $bill->id) }}"
                                data-ajax-popup="true" data-title="{{ __('Add Debit Note') }}" class="btn btn-primary">
                                {{ __('Add Debit Note') }}
                            </a>
                        </div>
                    @endif
                    ...
                    <div class="all-button-box">
                        <a href="{{ route('admin.bill.pdf', Crypt::encrypt($bill->id)) }}" target="_blank"
                                ...
                                <div class="col">
                                    <div class="float-end mt-3">
                                        {!! DNS2D::getBarcodeHTML(
                                            route('admin.bill.link.copy', \Illuminate\Support\Facades\Crypt::encrypt($bill->id)),
                                            'QRCODE',
                                            2,
                                            2,
                                        ) !!}
                                            ...
                                            @can('delete-bill')
                                                <li>
                                                    <a href="" class="deleteBtn"
                                                        data-href="{{ route('admin.bill.payment.destroy', [$bill->id, $payment->id]) }}">
                                    ...
                                    <td>
                                        <ul class="d-flex list-unstyled mb-0">
                                            @can('edit-bill')
                                                <li class="me-2">
                                                    <a
                                                        href="{{ route('admin.bill.edit.debit.note', [$debitNote->bill, $debitNote->id]) }}">
                                            ...
                                            @can('delete-bill')
                                                <li>
                                                    <a href="" class="deleteBtn"
                                                        data-href="{{ route('admin.bill.delete.debit.note', [$debitNote->bill, $debitNote->id]) }}">
                                                        <i class="link-icon" data-feather="delete"></i>
                                                    </a>
                                                </li>
                                            @endcan
